...
class DenMDN:
    ...
    def fit(self,x_points, y_points, encoded=True,lr = 0.001,n_workers=0): 
        ...
        n_gaussians = 512#self.config.config["n_gaussians_reg"]
...
def train(mode,name):
    ...
    t1 = time.time()
    d = Dataset.Data('./data/',train_file=None, test_file=None, update_path=None, transfer_set=None, x_attributes = ["body_type"], y_attributes = ["max_gross_weight"], sep=',')    
