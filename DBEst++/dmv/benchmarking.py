...
if __name__=="__main__":
    ...
    #                   benchmark_dir='benchmark/alldata', cat_att="body_type", range_att="max_gross_weight", 
    #                   sep=',', type='alldata', agg=agg)
    run_single_file(model="base.dill",query_file='benchmark/alldata/count00.sql', ground_truth='benchmark/alldata/count00.csv', _type='q-error')
    run_single_file(model="base.dill",query_file='benchmark/alldata/sum00.sql', ground_truth='benchmark/alldata/sum00.csv', _type='relative-error')
    run_single_file(model="base.dill",query_file='benchmark/alldata/avg00.sql', ground_truth='benchmark/alldata/avg00.csv', _type='relative-error')
