...
def query_gt_setup(main_train_file, updates_dir, benchmark_dir, cat_att, range_att, sep, type, agg):
    ...
    for file in np.sort(os.listdir(updates_dir)):
        if file.endswith('.csv') and not('test' in file):
...
if __name__=="__main__":
    ...
    #                   benchmark_dir='benchmark/alldata', cat_att="slope", range_att="elevation", 
    #                   sep=',', type='alldata', agg=agg)
    run_single_file(model="update01.dill",query_file='benchmark/alldata/count01.sql', ground_truth='benchmark/alldata/count01.csv', _type='q-error')
    run_single_file(model="update01.dill",query_file='benchmark/alldata/sum01.sql', ground_truth='benchmark/alldata/sum01.csv', _type='relative-error')
    run_single_file(model="update01.dill",query_file='benchmark/alldata/avg01.sql', ground_truth='benchmark/alldata/avg01.csv', _type='relative-error')
