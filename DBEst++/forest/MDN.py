...
class DenMDN:
    ...
    def update(self,x_points_update, y_points_update, x_points_transfer, y_points_transfer, encoded=True,lr = 0.001, n_epoch=20, alpha=0.16, n_workers=0, num_gauss=40, hid_neurons=2): 
...
def train(mode,name):
    ...
    t1 = time.time()
    d = Dataset.Data('./data/',train_file=None, test_file=None, update_path=None, transfer_set=None, x_attributes = ["slope"], y_attributes = ["elevation"], sep=',')    
    d.train_update_split(table='forest_for_MDN.csv', haveheader=True, permute=True, convert_to_timestamp=False, percentage=0.2,num_update_chunks=1)  
...
if __name__=="__main__":
    ...
    update_with_fusion(basemodel="base.dill", tr_size=58000)
