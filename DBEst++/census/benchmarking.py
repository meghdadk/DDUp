...
if __name__=="__main__":
    ...
    #                   benchmark_dir='benchmark/alldata', cat_att="country", range_att="age", 
    #                   sep=',', type='alldata', agg=agg)
    run_single_file(model="retrain01.dill",query_file='benchmark/alldata/count01.sql', ground_truth='benchmark/alldata/count01.csv', _type='q-error')
    run_single_file(model="retrain01.dill",query_file='benchmark/alldata/sum01.sql', ground_truth='benchmark/alldata/sum01.csv', _type='relative-error')
    run_single_file(model="retrain01.dill",query_file='benchmark/alldata/avg01.sql', ground_truth='benchmark/alldata/avg01.csv', _type='relative-error')
