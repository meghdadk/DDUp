...
def TrainTask(seed=0):
    ...
    assert args.dataset in ['dmv-tiny', 'dmv','tpcds_store_sales','census']
    if args.dataset == 'dmv-tiny':
        ...
        train = datasets.LoadData(root='data/', filename='train.csv', cols=None)
    ...
    if args.heads > 0:
        ...
        if args.dataset in ['dmv-tiny', 'dmv', 'tpcds_store_sales','census']:
            model = MakeMade(
