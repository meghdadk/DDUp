...
def FineTuneTask(pre_model, seed=0):
    ...
    if args.dataset == 'dmv-tiny':
        ...
        table, split_indices = datasets.LoadCensus(batch_num=None, finetune=True)
    elif args.dataset == 'forest':
    ...
    for update_step, split_index in enumerate(split_indices):
        ...
        if isinstance(model, transformer.Transformer):
            ...
            opt = torch.optim.Adam(list(model.parameters()), lr=4e-5)
            decay_rate = 0.98
            lr_scheduler = torch.optim.lr_scheduler.ExponentialLR(
                optimizer=opt, gamma=decay_rate
            )
...
UpdateTask(pre_model='models/census-38.5MB-model30.303-data15.573-made-resmade-hidden256_256_256_256_256-emb32-directIo-binaryInone_hotOut-inputNoEmbIfLeq-colmask-20epochs-seed0.pt')
#FineTuneTask(pre_model='models/census-38.5MB-model30.303-data15.573-made-resmade-hidden256_256_256_256_256-emb32-directIo-binaryInone_hotOut-inputNoEmbIfLeq-colmask-20epochs-seed0.pt')
