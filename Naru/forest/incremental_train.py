...
def FineTuneTask(pre_model, seed=0):
    ...
    for update_step, split_index in enumerate(split_indices):
        ...
        train_losses = []
        train_start = time.time()
        print ("finetuning, initial lr = {}, update batch {}".format(opt.param_groups[0]['lr'], update_step))
        for epoch in range(args.epochs):
...
#UpdateTask(pre_model='models/00forest-23.7MB-model59.664-data19.148-made-resmade-hidden256_256_256_256_256-emb32-directIo-binaryInone_hotOut-inputNoEmbIfLeq-colmask-20epochs-seed0.pt')
#FineTuneTask(pre_model='models/00forest-23.7MB-model59.664-data19.148-made-resmade-hidden256_256_256_256_256-emb32-directIo-binaryInone_hotOut-inputNoEmbIfLeq-colmask-20epochs-seed0.pt')
